...
memory.o: memory.c modules/C-memory-manager/memory_manager.h modules/C-memory-manager/memory_manager.c modules/C-page-allocator/page_allocator.c modules/C-page-allocator/page_allocator.h
	gcc -m64 $(CFLAGS) -c $^
BUILD += memory.o
